...
void Base_Circuits::initialize(const bigint &p)
{
   ...
   */
  loaded.insert(make_pair( 66001, false));
  location.insert(make_pair(66001, "Circuits/Bristol/less_than_eq.txt"));
  loaded.insert(make_pair( 66002, false));
  location.insert(make_pair(66002, "Circuits/Bristol/less_than_eq_with_xor.txt"));
}
