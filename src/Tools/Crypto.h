...
/* This file defines various helper crypto routines we need  SHA256 based hash of a string */
...
/* Protocols for agreeing on random data  Create a random gfp element agreed between the players */
...
/* Protocols to commit and open to data  This runs the Commit and Open Protocol for data[i][j] of type T
 *   0 <= i < data.size()
 *   0 <= j < num_players
