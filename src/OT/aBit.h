...
class aBit
{
  ...
  public:
    ...
    bool operator==(const aBit &other) const
    {
        return K == other.K;
    }
...
#pragma GCC diagnostic ignored "-Wunused-parameter"
    ...
    void assign_zero([[maybe_unused]] int p)
    {
        assign_zero();
    }
    void assign_one([[maybe_unused]] int p)
    {
        assign_one();
    }
#pragma GCC diagnostic pop
    ...
    vector<gf2n> get_MACs() const
    {
        return vector<gf2n>(M);
    }
    ...
    vector<gf2n> get_Keys() const
    {
        return vector<gf2n>(K);
    }
    ...
    void set_MACs(vector<gf2n> macs)
    {
        M = macs;
    }
    ...
    void set_Keys(vector<gf2n> keys)
    {
        K = keys;
    }
